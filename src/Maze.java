...
public class Maze {
    ...
    public Maze(int level) {    //hàm hiển thị map lên màn hình trò chơi
        try {
    ...
    private void inputProcess(ArrayList<String> keyInput, long timer) { //cập nhật trạng thái từ bàn phím
